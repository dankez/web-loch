...
while (offset + 16 <= buffer.byteLength) {
  ...
  if (type === 4) {
      ...
      for (let i = 0; i < 5; i++) {
         ...
         const x = view.getFloat32(rOff + 8, true);
         const y = view.getFloat32(rOff + 12, true);
         const z = view.getFloat32(rOff + 16, true);
         console.log(`Type4 [${i}]: from=${fromId}, sm1=${something1}, dx=${x}, dy=${y}, dz=${z}`);
      }
  }
